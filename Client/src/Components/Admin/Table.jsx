        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          {isFiltered && (
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-red-500 text-white hover:bg-red-600 rounded-lg transition shadow-sm font-medium"
            >
              <X className="w-4 h-4" />
              Clear Filters
            </button>
                  ...
                  <tr>
                    <td colSpan="8" className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center justify-center">
                        <X className="w-12 h-12 text-gray-400 mb-3" />
            ...
            {sortedData.length > 0 && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-gray-100 hover:bg-gray-200 disabled:bg-gray-50 disabled:text-gray-400 disabled:cursor-not-allowed rounded-lg transition text-sm font-semibold border border-gray-300"
                >
                  Previous
                </button>
