  ...
  return (
      <BaseLayout>
        ...
        <div className="w-[90%] md:w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 my-6 md:my-10">
          ...
          <div className="flex flex-col items-center justify-center py-6 md:py-10 px-4 md:px-6 text-center text-white bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl cursor-pointer hover:scale-105 hover:bg-white/10 transition-all shadow-lg group">
            <h2 className="font-semibold mb-2 text-white/70 text-xs md:text-xl uppercase tracking-wider group-hover:text-white transition-colors">Completed Tasks</h2>
          ...
          <div className="flex flex-col items-center justify-center py-6 md:py-10 px-4 md:px-6 text-center text-white bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl cursor-pointer hover:scale-105 hover:bg-white/10 transition-all shadow-lg group">
            <h2 className="font-semibold mb-2 text-white/70 text-xs md:text-xl uppercase tracking-wider group-hover:text-white transition-colors">On-Going Tasks</h2>
        ...
        <div className="w-[90%] md:w-[80%] mx-auto my-6 flex flex-row items-center justify-between gap-4">
          <h1 className="text-lg md:text-2xl font-bold text-white">Tasks Table:</h1>
          <button 
            onClick={exportToExcel}
            className="bg-white/10 backdrop-blur-md border border-white/20 hover:bg-red-600 hover:border-red-500 text-white px-3 md:px-5 py-2 md:py-2.5 rounded-xl transition-all shadow-lg hover:scale-105 flex items-center justify-center gap-2 text-xs md:text-sm font-semibold"
          >
            <span>Export</span>
