...
import { Plus, Eye, House, Activity, X, ChevronDown } from "lucide-react";
...
const FacultyDashboard = () => {
  ...
  return (
    <BaseLayout>
      ...
      <div className="w-[90%] md:w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 my-10">
        <div className="flex flex-col items-center justify-center py-6 md:py-10 px-4 md:px-6 text-center text-white bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl cursor-pointer hover:scale-105 hover:bg-white/10 transition-all shadow-lg group">
          <h2 className="font-semibold mb-2 text-white/70 text-xs md:text-xl uppercase tracking-wider group-hover:text-white transition-colors">Assigned Tasks</h2>
        ...
        <div className="flex flex-col items-center justify-center py-6 md:py-10 px-4 md:px-6 text-center text-white bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl cursor-pointer hover:scale-105 hover:bg-white/10 transition-all shadow-lg group">
          <h2 className="font-semibold mb-2 text-white/70 text-xs md:text-xl uppercase tracking-wider group-hover:text-white transition-colors">Pending Tasks</h2>
